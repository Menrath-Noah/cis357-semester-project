...
import com.example.prototype_semesterproject.Square3
import com.example.prototype_semesterproject.Square2
import com.example.prototype_semesterproject.Triangle
import com.example.prototype_semesterproject.horizontalData
import com.example.prototype_semesterproject.verticalData
import com.example.prototype_semesterproject.zData
...
class GameConfig : ComponentActivity() {
   ...
   override fun onCreate(savedInstanceState: Bundle?) {
    ...
    class MyGLSurfaceView(context: GameConfig) : GLSurfaceView(context) {
...
//                        block.xVal = camX
    ...
    class SensorManagerModel(context: GameConfig) : SensorEventListener {
        ...
        fun changeSensorData(newSensorData: FloatArray) {
            if (newSensorData.isNotEmpty()) {
                var horizontal: Float = newSensorData[0]
